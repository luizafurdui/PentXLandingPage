...
export default function NavBar() {
  ...
  return (
    <nav className={`sticky top-0 mt-5 z-50 backdrop-blur-lg border border-neutral-700/80 rounded-[15px] w-full md:w-[65em] mx-auto ${isOpen ? 'h-[45rem]' : 'h-auto'} transition-all duration-700`}>
          ...
          <div className="flex md:hidden mr-2">
            ...
            >
              <Lottie 
                ...
                speed={3}
                isStopped={!isOpen} // Only play when open
              />
            </button>
          </div>
        </div>
        ...
        <div className={`md:hidden absolute top-16 left-0 w-full overflow-hidden transition-all duration-700 ease-in-out ${isOpen ? 'max-h-80' : 'max-h-0'}`}>
          <div className="">
            <div className="flex flex-col text-lg font-medium text-white space-y-2">
              <a href="#" className="transition duration-300 ease-in-out py-2 px-4">Features</a>
              <a href="#" className="transition duration-300 ease-in-out py-2 px-4">Team</a>
              <a href="#" className="transition duration-300 ease-in-out py-2 px-4">Contact</a>
              <a href="#" className="transition duration-300 ease-in-out py-2 px-4">Join PentX</a>
            </div>
          </div>
        </div>
      </div>
